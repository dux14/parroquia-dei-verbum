      ...
      <section className="py-12 px-4 md:px-6 max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {impact.map((item) => (
            ...
            >
              <span className="material-symbols-outlined text-primary text-[36px] mb-2">{item.icon}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service) => (
            <div key={service.icon} className="bg-surface-container-lowest rounded-xl p-8 soft-shadow border-l-2 border-pew-oak">
              <span className="material-symbols-outlined text-altar-gold text-[32px] mb-4">{service.icon}</span>
      ...
      <section className="py-12 px-4 md:px-6 max-w-[820px] mx-auto mb-16 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-10">
          <a
            ...
            href="tel:3107533534"
          >
            <span className="material-symbols-outlined">call</span>310 753 3534
          </a>
          <a
